...
public:
    ...
    bool UpdateList(int Index, T NewValue)
    {
    ...
    bool InsertAfter(int Index, T value)
    {
        ...
        //if (ItemNode->next != NULL) ... but this was problematic due to the fact that GetNode(Index)
        //Return a Node or a NULL, so if it returned a NULL and then we wrote this line NULL->next this
        //will make problems.
        if (ItemNode!= NULL)
        {
